...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen text-white overflow-hidden">
      ...
      <div
        aria-hidden
        className={`absolute top-0 right-0 translate-x-1/4 -translate-y-1/4 pointer-events-none transition-transform duration-700 ease-out ${
          mounted
      ...
      <div className="relative z-10 max-w-7xl mt-40 mx-auto px-8 pt-16 pb-4 flex items-start min-h-[calc(100vh-4rem)]">
        <div className="w-full">
          ...
          <div
            className={`mt-20 flex justify-center pointer-events-auto transition-opacity duration-700 ease-out ${
