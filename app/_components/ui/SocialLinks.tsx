        ...
        {SOCIAL_LINKS.map((item, i) => (
          ...
          >
            <a
              ...
              className="group flex items-center gap-3 px-3 sm:px-6 py-2 border border-white/10 rounded-full bg-black/40 backdrop-blur-md text-sm text-gray-200 hover:bg-white hover:text-black transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 hover:shadow-xl hover:shadow-white/20 focus:outline-none focus:ring-2 focus:ring-white/20 w-auto sm:w-full lg:w-auto"
            >
