    ...
    return (
      <div className="relative mb-6 rounded-3xl overflow-visible">
        ...
        <div className="relative z-10 h-[400px]">
          ...
          <div className="absolute bottom-0 right-0 w-[30%] aspect-square overflow-hidden rounded-2xl">
            <img 
              src={images[1]} 
              alt={`${alt} 2`} 
              className="w-full h-full object-cover" 
    ...
    <div className="relative flex items-start justify-end min-h-[600px]">
      ...
      >
        ...
        <div className="relative w-[600px] h-[608px] flex-shrink-0">
          ...
          <div className="absolute top-0 left-0 w-full h-[400px] overflow-hidden rounded-[32px] transition-all"
               style={{ 
          ...
          <div className="absolute bottom-[calc(200px+8px)] right-0 w-[200px] h-[200px] overflow-hidden rounded-[32px] transition-all">
            <img 
              src={images[1]} 
              alt={`${alt} 2`} 
              className="w-full h-full object-cover" 
          ...
          {/* Blue square - bottom */}
          <div className="absolute bottom-0 right-[210px] w-[200px] h-[200px] overflow-hidden rounded-[32px] transition-all">
            <img 
              src={images[3]} 
              alt={`${alt} 4`} 
              className="w-full h-full object-cover" 
        ...
        <div className="w-[200px] h-[400px] overflow-hidden rounded-[32px] transition-all flex-shrink-0">
          <img 
            src={images[2]} 
            alt={`${alt} 3`} 
            className="w-full h-full object-cover" 
