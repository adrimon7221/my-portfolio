/**
 * Componente de modal de confirmación para eliminar artículos
 * 
      ...
      <DialogContent className="bg-[#3D3D3D] border border-white/10 rounded-2xl max-w-md [&_[data-slot='dialog-close']]:cursor-pointer">
        <DialogHeader>
          ...
          <DialogDescription className="text-white/60">
            ¿Estás seguro de que deseas eliminar el artículo <span className="font-semibold text-white">{articleTitle}</span>? Esta acción no se puede deshacer.
          </DialogDescription>
        </DialogHeader>
